 ...
 */
case class RasterEvalPython(udfs: Seq[PythonRasterUDF], output: Seq[Attribute], child: LogicalPlan)
  extends UnaryNode

/**
 * A physical plan that evaluates a [[PythonUDF]].
 */
case class RasterEvalPythonExec(udfs: Seq[PythonRasterUDF], output: Seq[Attribute], child: SparkPlan)
  extends EvalPythonExec(udfs.map(_.toPythonUDF), output, child) {
